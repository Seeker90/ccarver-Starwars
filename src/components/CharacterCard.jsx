...
export const CharacterCard = ({uid, name, gender, skin_color, hair_color, isFavorited, dispatch}) => {
        ...
        <>
            <div className="card" style={style}>
                ...
                <div className="card-body">
                    ...
                    <p className="mb-1">Skin Color: {skin_color}</p>
                    <p className="mb-1">Hair Color: {hair_color}</p>
                    <div className="both-buttons d-flex justify-content-between">
